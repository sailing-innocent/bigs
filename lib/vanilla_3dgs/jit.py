...
_C = load(
    "rasterize_gaussians", [
        "lib/cuda_rasterizer/rasterize_points.cu",
        "lib/cuda_rasterizer/rasterizer_impl.cu",
        "lib/cuda_rasterizer/forward.cu",
        "lib/cuda_rasterizer/backward.cu",
        "lib/cuda_rasterizer/ext.cpp"
    ],
    verbose=True,
