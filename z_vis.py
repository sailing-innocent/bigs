...
def vis_gs_round_cams(root):
    ...
    for i in range(0, 360, 20):
        theta = i / 180 * np.pi
        cam, pos = get_round_cam(rot_center, axis, eye_fix_point, theta, scale=3.0, world_name="colmap")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source", type=str, default="data/pretrained/gaussian/mip360_kitchen_30000.ply")
