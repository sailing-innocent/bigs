...
def evaluate(feat_dir, output_path, json_folder, mask_thresh, logger):
    ...
    eval_index_list = [int(idx) for idx in list(gt_ann.keys())] # The gt frames
    # generate the compressed feature for each query key 
...
if __name__ == "__main__":
    ...
    feat_dir = [os.path.join(args.feat_dir, dataset_name+f"_{i}", "train/ours_None/out_npy") for i in range(1,4)]
    ...
    evaluate(feat_dir, output_path,  json_folder, mask_thresh, logger)