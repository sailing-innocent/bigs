...
class OpenCLIPNetwork:
    ...
    def get_relevancy(self, embed: torch.Tensor, positive_id: int) -> torch.Tensor:
        ...
        p = phrases_embeds.to(embed.dtype) # concat the positive and negative phrases
        output = torch.mm(embed, p.T) # cosine similarity
    ...
    def get_max_across(self, sem_map):
        # print("Semantic Map Input: ", sem_map.shape) # 3, 730, 988, 512 (level, h, w, clip_dim)
