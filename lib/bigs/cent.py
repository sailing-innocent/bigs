# -*- coding: utf-8 -*-
# @file gs_feat_mark.py
# @brief featmark interface
...
from cent.lib.sailtorch.gs import gs_feat_mark
from cent.lib.sailtorch.gs import gs_feat_mark_debug
import torch 
import numpy as np 
...
def gs_mark(gs: GaussianModel, cam: Camera, feat_img: torch.Tensor, feat: torch.Tensor):
    ...
    num_rendered = gs_feat_mark(*args)
    # print(num_rendered)
...
def gs_mark_debug(gs: GaussianModel, cam: Camera, feat: torch.Tensor):
    ...
    num_rendered = gs_feat_mark_debug(*args)
    print(num_rendered)
